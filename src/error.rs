...
pub enum ErrorCode {
    ...
    Other = 5,
    // 6-99: Reserved for future cimple library errors
...
impl Error {
    ...
    /// Error code ranges:
    /// - 0: No error
    /// - 1-99: Core cimple infrastructure errors
    ...
    ///
    /// This method takes an error from an external crate and converts it to a cimple Error
